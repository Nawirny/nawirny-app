...
win32 {
    ...
    CONFIG(debug, debug|release) {
        ...
        LIBS += -Lqmapcontrol/src/QMapControl/lib -lqmapcontrold1
    }
    CONFIG(release, debug|release) {
        # Add QMapControl library.
        LIBS += -Lqmapcontrol/src/QMapControl/lib -lqmapcontrol1
    }
}
...
unix {
    ...
    CONFIG(debug, debug|release) {
        # Add QMapControl library.
        LIBS += -Lqmapcontrol/src/QMapControl/lib -lqmapcontrold
    }
    CONFIG(release, debug|release) {
        # Add QMapControl library.
        LIBS += -Lqmapcontrol/src/QMapControl/lib -lqmapcontrol
    }
}
...
target_libs.commands = -$(INSTALL_FILE) $$system_path(QMapControl/src/QMapControl/lib/*) $$system_path(bin/.)
